  ...
  return (
    <>
        ...
        <div className="-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div className="shadow overflow-hidden sm:rounded-lg">
              <table
                {...getTableProps()}
                className="min-w-full divide-y divide-neutral-600"
              >
      ...
      <div className="py-3 flex items-center justify-between">
        <div className="flex-1 flex gap-x-2 mt-4 justify-between sm:hidden">
        ...
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          <div className="flex gap-x-2 items-baseline">
            ...
            <label>
              ...
              <select
                className="mt-1 block w-full rounded-md bg-neutral-700 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
